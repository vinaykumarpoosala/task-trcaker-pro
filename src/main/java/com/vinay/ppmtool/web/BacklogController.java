...
import com.vinay.ppmtool.service.ProjectTaskService;
...
public class BacklogController {
	...
	public ResponseEntity<?> addProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
		...
		return new ResponseEntity<ProjectTask>(projectTaskService.addProjectTask(backlog_id, projectTask , principal.getName()),
				HttpStatus.CREATED);

	}

	@GetMapping("/{backlog_id}")
	public Iterable<ProjectTask> getBacklogTasks(@PathVariable String backlog_id) {

		return projectTaskService.getAllTasks(backlog_id);
	}
	...
	public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask updatedTask, BindingResult result,
		...
		ProjectTask projectTask = projectTaskService.updateByProjectSequence(updatedTask, backlog_id, pt_id , principal.getName());
